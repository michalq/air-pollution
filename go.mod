...
require (
	...
	github.com/michalq/go-airly-api-client v0.1.0
	github.com/michalq/go-gios-api-client v0.1.4
	...
	golang.org/x/tools v0.0.0-20190917212132-1cc945182204 // indirect
